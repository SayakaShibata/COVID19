...
xhttp.onreadystatechange = function() {
	...
	if (this.readyState == 4 && this.status == 200) {
		...
		var html='';
		html += `<div class="col-sm-12"><div class="card my-3"><div class="card-header">Global Cases</div><div class="card-body "><div class="date card-subtitle mb-2 text-muted text-right">update:`
				+today+`</div><h5 class="card-title">new Case:<mark>`+g.NewConfirmed + `</mark></h5><p class="blockquote-footer">total:`+g.TotalConfirmed + `</p><h6>new Death:`
				+g.NewDeaths + `</h6><p class="blockquote-footer">total:`+g.TotalDeaths + `</p><h6>new Recovered:`
				+g.NewRecovered+`</h6><p class="blockquote-footer">total:`+g.TotalRecovered+`</p><h5>Active:<mark>`+gAct+ `</mark></h5></div></div></div>`;
			
			for(var i=0; i< code.length; i++){
				var n = code[i];
				var d = r.Countries[n];
				var dAct = d.TotalConfirmed - d.TotalRecovered - d.TotalDeaths;
				html+=`<div class="col-sm-4"><div class="card my-3"><div class="card-header">`+d.Country+` Cases</div><div class="card-body "><h5 class="card-title">new Case:<mark>`
